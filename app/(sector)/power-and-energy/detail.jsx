...
import power from "@/public/assets/images/PE.jpg";
...
export default function SectorDetails() {
  ...
  const schemaData = {
    ...
    "@type": "WebPage",
    name: "Power & Energy - Capital Engineering Consultancy",
    description:
      "Discover our expertise in power and energy solutions at Capital Engineering Consultancy, delivering efficient, sustainable, and innovative infrastructure for modern energy needs.",
  ...
  return (
    <>
      ...
      <Head>
        <title>Power & Energy | Capital Engineering Consultancy</title>
        <meta
          name="description"
          content="Explore our power and energy solutions at Capital Engineering Consultancy, designing optimized power plants, renewable integration, and smart grid systems for sustainable energy."
        />
        <meta
          name="keywords"
          content="power infrastructure, renewable energy, smart grids, Capital Engineering Consultancy, energy storage, power plant optimization"
        />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link
          rel="canonical"
          href="https://www.capitalengg.com/power-and-energy"
        />
        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="Power & Energy | Capital Engineering Consultancy"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.capitalengg.com/power-and-energy"
        />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={power.src} />
        {/* Twitter Card Tags */}
        ...
        <meta
          ...
          content="Explore our power and energy solutions at Capital Engineering Consultancy, designing optimized power plants, renewable integration, and smart grid systems for sustainable energy."
        />
        <meta name="twitter:image" content={power.src} />
        {/* Schema Markup */}
        <script
      ...
      <section
        ...
        aria-labelledby="power-energy-title"
      >
          ...
          <div className="col-xl-12">
            <div className="project-inner-thumb mb-80 wow img-custom-anim-top animated">
              <Image
                ...
                className="w-100"
                src={power}
                alt="Power and energy facility by Capital Engineering Consultancy"
                priority
              />
            </div>
          </div>
          ...
          <div className="row justify-content-between flex-row-reverse">
            ...
            <article className="col-lg-8">
              ...
              <p className="sec-text mb-n1" style={{ textAlign: "justify" }}>
                ...
                Designs that boost operational efficiency while minimizing
                environmental impact, supporting your goals for sustainable
                energy.
                <br />
                <b style={{ color: "#071E53" }}>
                  • Seamless Transmission Networks:
                </b>{" "}
                Reliable infrastructure to transfer energy efficiently across
                challenging terrains, ensuring uninterrupted supply.
                <br />
                <b style={{ color: "#071E53" }}>
                ...
                Facilitating the seamless incorporation of renewable energy
                sources into existing systems for greener, cost-effective
                operations.
                <br />
                <b style={{ color: "#071E53" }}>
