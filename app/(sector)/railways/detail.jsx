...
export default function SectorDetails() {
  ...
  const schemaData = {
    ...
    "@type": "WebPage",
    name: "Railways - Capital Engineering Consultancy",
    description:
      "Explore our expertise in railway infrastructure at Capital Engineering Consultancy, delivering innovative, safe, and sustainable solutions for modern rail systems.",
  ...
  return (
    <>
      ...
      <Head>
        <title>Railways | Capital Engineering Consultancy</title>
        <meta
          name="description"
          content="Discover our railway solutions at Capital Engineering Consultancy, designing efficient tracks, advanced signaling systems, and sustainable rail infrastructure."
        />
        <meta
          name="keywords"
          content="railway infrastructure, track engineering, signaling systems, Capital Engineering Consultancy, sustainable rail, station design"
        />
        ...
        <meta
          property="og:title"
          content="Railways | Capital Engineering Consultancy"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.capitalengg.com/railways"
        />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={railway.src} />
        {/* Twitter Card Tags */}
        ...
        <meta
          ...
          content="Discover our railway solutions at Capital Engineering Consultancy, designing efficient tracks, advanced signaling systems, and sustainable rail infrastructure."
        />
        <meta name="twitter:image" content={railway.src} />
        {/* Schema Markup */}
        <script
      ...
      <section
        ...
        aria-labelledby="railways-title"
      >
          ...
          <div className="row justify-content-between flex-row-reverse">
            ...
            <article className="col-lg-8">
              ...
              <h2 style={{ color: "#071E53", marginBottom: "20px" }}>
                How We Partner with You to Achieve Success
              </h2>
              <p className="sec-text mb-n1" style={{ textAlign: "justify" }}>
                ...
                Creating passenger-friendly stations that enhance comfort and
                convenience.
                <br />
                <b style={{ color: "#071E53" }}>
                  • Depot and Maintenance Facilities:
                </b>{" "}
                Designing and optimizing facilities for efficient train
