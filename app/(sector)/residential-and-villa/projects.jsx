...
export default function Blogs() {
  ...
  React.useEffect(() => {
    const fetchBlogs = async () => {
      const query = `*[_type == "post" && "Residential & Villa" in categories[]->title] | order(publishedAt desc) {
        _id,
        title,
        publishedAt,
        mainImage{
  ...
  <div className="row align-items-center">
    <div className="col-md-6 text-start">
      <div className="title-area">
        <h2 className="sec-title" style={{ color: "#081761", textDecoration: "underline" }}>
          Explore Our Residential & Villa Projects
        </h2>
      </div>
    </div>
    <div className="col-md-6 text-end pb-5">
      <Link
        scroll={false}
        href="/portfolio?category=Residential+%26+Villa"
        className="btn"
        style={{
