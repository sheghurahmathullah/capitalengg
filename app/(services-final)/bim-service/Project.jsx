...
const cards = [
  {
    id: 1,
    src: "/assets/images/servicenew/bim/car.jpg",
    alt: "BIM modeling for automotive facility by Capital Engineering Consultancy",
    title: "Automotive Facility",
  },
  {
    id: 2,
    src: "/assets/images/servicenew/bim/RADISSON.jpg",
    alt: "Radisson BIM project by Capital Engineering Consultancy",
    title: "Radisson",
  },
  {
    id: 3,
    src: "/assets/images/servicenew/bim/ritz4.jpg",
    alt: "Ritz BIM modeling by Capital Engineering Consultancy",
    title: "Ritz",
  },
  {
    id: 4,
    src: "/assets/images/servicenew/bim/santoo seal.jpg",
    alt: "Santoo Seal BIM project by Capital Engineering Consultancy",
    title: "Santoo Seal",
  },
];
...
export default function CardSlider() {
  ...
  return (
    <section
      ...
      ref={containerRef}
      aria-labelledby="bim-portfolio-heading"
    >
      <h2 id="bim-portfolio-heading" className="sr-only">
        BIM Services Portfolio by Capital Engineering Consultancy
      </h2>
      ...
      >
        {!isMobile && (
          <>
            {/* <motion.button
              ...
              aria-label="Previous BIM portfolio image"
            >
            ...
            <motion.button
              ...
              aria-label="Next BIM portfolio image"
            >
        ...
        <div
          ...
          {...bind()}
          role="region"
          aria-label="BIM services portfolio carousel"
        >
          <AnimatePresence>
            {cards.map((card, i) => {
              if (!isMobile) {
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 z-50">
          {cards.map((_, i) => (
            <motion.button
              ...
              aria-label={`View BIM portfolio image ${i + 1}`}
            />
          ))}
        </div>
      </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            >
              At Capital Engineering Consultancy, our BIM services deliver precision
              and efficiency, integrating advanced modeling and coordination to
              optimize construction projects from concept to completion.
            </motion.p>
          </div>
        </div>
      </motion.div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CreativeWork",
            "name": "BIM Services Portfolio",
            "creator": {
              "@type": "Organization",
              "name": "Capital Engineering Consultancy",
            },
            "description":
              "A showcase of advanced BIM projects by Capital Engineering Consultancy, including automotive facilities, Radisson, Ritz, and Santoo Seal, demonstrating precision and efficiency in construction.",
