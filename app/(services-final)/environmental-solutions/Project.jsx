...
const cards = [
  {
    id: 1,
    src: "/assets/images/servicenew/envi/Alajda STP views-images-1.jpg",
    alt: "Alajda environmental solutions project by Capital Engineering Consultancy",
    title: "Alajda STP",
  },
  {
    id: 2,
    src: "/assets/images/servicenew/envi/shj-2238-stp-massar.jpg",
    alt: "Massar environmental management project by Capital Engineering Consultancy",
    title: "Massar STP",
  },
  {
    id: 3,
    src: "/assets/images/servicenew/envi/STP, Houma-images-0.jpg",
    alt: "Houma environmental solutions project by Capital Engineering Consultancy",
    title: "Houma STP",
  },
  {
    id: 4,
    src: "/assets/images/servicenew/envi/shj-2220-stp-dhaid-eagle.jpg",
    alt: "Dhaid Eagle environmental management project by Capital Engineering Consultancy",
    title: "Dhaid Eagle STP",
  },
];
...
export default function CardSlider() {
  ...
  return (
    <section
      ...
      ref={containerRef}
      aria-labelledby="environmental-portfolio-heading"
    >
      <h2 id="environmental-portfolio-heading" className="sr-only">
        Environmental Solutions Portfolio by Capital Engineering Consultancy
      </h2>
      ...
      >
        {!isMobile && (
          <>
            {/* <motion.button
              ...
              aria-label="Previous environmental portfolio image"
            >
            ...
            <motion.button
              ...
              aria-label="Next environmental portfolio image"
            >
        ...
        <div
          ...
          {...bind()}
          role="region"
          aria-label="Environmental solutions portfolio carousel"
        >
          <AnimatePresence>
            {cards.map((card, i) => {
              if (!isMobile) {
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 z-50">
          {cards.map((_, i) => (
            <motion.button
              ...
              aria-label={`View environmental portfolio image ${i + 1}`}
            />
          ))}
        </div>
      </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            >
              At Capital Engineering Consultancy, our environmental solutions integrate
              sustainability and innovation, delivering projects like Alajda STP and
              Dhaid Eagle STP that ensure long-term environmental excellence and
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CreativeWork",
            "name": "Environmental Solutions Portfolio",
            "creator": {
              "@type": "Organization",
              "name": "Capital Engineering Consultancy",
            },
            "description":
              "A showcase of Capital Engineering Consultancy’s environmental solutions projects, including Alajda STP, Massar STP, Houma STP, and Dhaid Eagle STP, promoting sustainability and environmental management.",
            "image": cards.map((card) => card.src),
            "keywords":
              "environmental solutions, sustainability, environmental management, STP projects, Capital Engineering Consultancy",
          }),
        }}
      />
    </section>
