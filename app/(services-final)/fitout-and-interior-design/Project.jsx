...
const cards = [
  {
    id: 1,
    src: "/assets/images/servicenew/fit/Azalia 3D Interior.jpg",
    alt: "Azalia interior design project by Capital Engineering Consultancy",
    title: "Azalia 3D Interior",
  },
  {
    id: 2,
    src: "/assets/images/servicenew/fit/Gazebo-Marina Mall.png",
    alt: "Gazebo Marina Mall fitout project by Capital Engineering Consultancy",
    title: "Gazebo Marina Mall",
  },
  {
    id: 3,
    src: "/assets/images/servicenew/fit/Low Calories.png",
    alt: "Low Calories interior fitout by Capital Engineering Consultancy",
    title: "Low Calories",
  },
  {
    id: 4,
    src: "/assets/images/servicenew/fit/Roberto Cavalli (1).png",
    alt: "Roberto Cavalli interior design project by Capital Engineering Consultancy",
...
export default function CardSlider() {
  ...
  return (
    <section
      ...
      ref={containerRef}
      aria-labelledby="interior-design-portfolio-heading"
    >
      <h2 id="interior-design-portfolio-heading" className="sr-only">
        Interior Design and Fitout Portfolio by Capital Engineering Consultancy
      </h2>
      ...
      >
        {!isMobile && (
          <>
            {/* <motion.button
              ...
              aria-label="Previous interior design portfolio image"
            >
            ...
            <motion.button
              ...
              aria-label="Next interior design portfolio image"
            >
        ...
        <div
          ...
          {...bind()}
          role="region"
          aria-label="Interior design and fitout portfolio carousel"
        >
          <AnimatePresence>
            {cards.map((card, i) => {
              if (!isMobile) {
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 z-50">
          {cards.map((_, i) => (
            <motion.button
              ...
              aria-label={`View interior design portfolio image ${i + 1}`}
            />
          ))}
        </div>
      </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            >
              At Capital Engineering Consultancy, our fitout and interior design
              services create stunning, sustainable spaces, as showcased in projects
              like Azalia 3D Interior, Gazebo Marina Mall, and Roberto Cavalli,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CreativeWork",
            "name": "Interior Design and Fitout Portfolio",
            "creator": {
              "@type": "Organization",
              "name": "Capital Engineering Consultancy",
            },
            "description":
              "A showcase of Capital Engineering Consultancy’s interior design and fitout projects, including Azalia 3D Interior, Gazebo Marina Mall, Low Calories, and Roberto Cavalli, delivering sustainable and innovative spaces.",
            "image": cards.map((card) => card.src),
            "keywords":
              "interior design, fitout services, sustainable design, commercial fitout, residential interior design, Capital Engineering Consultancy",
          }),
        }}
      />
    </section>
