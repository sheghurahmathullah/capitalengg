...
const cards = [
  {
    id: 1,
    src: "/assets/images/servicenew/mep/Chlor-Alkali Chemical Plant – Sur Industrial City, Oman.jpg",
    alt: "Chlor-Alkali Chemical Plant MEP design project by Capital Engineering Consultancy",
    title: "Chlor-Alkali Chemical Plant",
  },
  {
    id: 2,
    src: "/assets/images/servicenew/mep/Dulsco Re-Refinery Plant – Jebel Ali, UAE.jpeg",
    alt: "Dulsco Re-Refinery Plant MEP design project by Capital Engineering Consultancy",
    title: "Dulsco Re-Refinery Plant",
  },
  {
    id: 3,
    src: "/assets/images/servicenew/mep/JSW Cement – Fujairah Clinker Plant1.jpeg",
    alt: "JSW Cement Fujairah Clinker Plant MEP design project by Capital Engineering Consultancy",
    title: "JSW Cement Fujairah Clinker Plant",
  },
  {
    id: 4,
    src: "/assets/images/servicenew/mep/Lime Kiln Factory – ICAD III, Abu Dhabi.jpeg",
    alt: "Lime Kiln Factory MEP design project by Capital Engineering Consultancy",
    title: "Lime Kiln Factory",
  },
];
...
export default function CardSlider() {
  ...
  return (
    <section
      ...
      ref={containerRef}
      aria-labelledby="mep-portfolio-heading"
    >
      <h2 id="mep-portfolio-heading" className="sr-only">
        MEP Design Portfolio by Capital Engineering Consultancy
      </h2>
      ...
      >
        {!isMobile && (
          <>
            {/* <motion.button
              ...
              aria-label="Previous MEP portfolio image"
            >
            ...
            <motion.button
              ...
              aria-label="Next MEP portfolio image"
            >
        ...
        <div
          ...
          {...bind()}
          role="region"
          aria-label="MEP design portfolio carousel"
        >
          <AnimatePresence>
            {cards.map((card, i) => {
              if (!isMobile) {
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 z-50">
          {cards.map((_, i) => (
            <motion.button
              ...
              aria-label={`View MEP portfolio image ${i + 1}`}
            />
          ))}
        </div>
      </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            >
              At Capital Engineering Consultancy, our MEP design services deliver
              sustainable and efficient solutions, as demonstrated in projects like
              Chlor-Alkali Chemical Plant, Dulsco Re-Refinery Plant, and JSW Cement
              Fujairah Clinker Plant, ensuring engineering excellence.
            </motion.p>
          </div>
        </div>
      </motion.div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CreativeWork",
            "name": "MEP Design Portfolio",
            "creator": {
              "@type": "Organization",
              "name": "Capital Engineering Consultancy",
            },
            "description":
              "A showcase of Capital Engineering Consultancy’s MEP design projects, including Chlor-Alkali Chemical Plant, Dulsco Re-Refinery Plant, JSW Cement Fujairah Clinker Plant, and Lime Kiln Factory, delivering sustainable and efficient engineering solutions.",
