...
const cards = [
  {
    id: 1,
    src: "/assets/images/servicenew/oil/dulsco.jpeg",
    alt: "Dulsco Oil & Gas engineering project by Capital Engineering Consultancy",
    title: "Dulsco",
  },
  {
    id: 2,
    src: "/assets/images/servicenew/oil/emirates2.jpeg",
    alt: "Emirates Marine Ports engineering project by Capital Engineering Consultancy",
    title: "Emirates",
  },
  {
    id: 3,
    src: "/assets/images/servicenew/oil/hidd.jpg",
    alt: "Hidd Oil & Gas engineering project by Capital Engineering Consultancy",
    title: "Hidd",
  },
  {
    id: 4,
    src: "/assets/images/servicenew/oil/mbk.jpg",
    alt: "MBK Marine Ports engineering project by Capital Engineering Consultancy",
    title: "MBK",
  },
];
...
export default function CardSlider() {
  ...
  return (
    <section
      ...
      ref={containerRef}
      aria-labelledby="oil-marine-portfolio-heading"
    >
      <h2 id="oil-marine-portfolio-heading" className="sr-only">
        Oil & Gas and Marine Ports Portfolio by Capital Engineering Consultancy
      </h2>
      ...
      >
        {!isMobile && (
          <>
            {/* <motion.button
              ...
              aria-label="Previous Oil & Gas and Marine Ports portfolio image"
            >
            ...
            <motion.button
              ...
              aria-label="Next Oil & Gas and Marine Ports portfolio image"
            >
        ...
        <div
          ...
          {...bind()}
          role="region"
          aria-label="Oil & Gas and Marine Ports portfolio carousel"
        >
          <AnimatePresence>
            {cards.map((card, i) => {
              if (!isMobile) {
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 z-50">
          {cards.map((_, i) => (
            <motion.button
              ...
              aria-label={`View Oil & Gas and Marine Ports portfolio image ${i + 1}`}
            />
          ))}
        </div>
      </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            >
              At Capital Engineering Consultancy, our Oil & Gas and Marine Ports
              engineering projects, including Dulsco, Emirates, Hidd, and MBK,
              showcase our commitment to delivering sustainable, efficient, and
              innovative infrastructure solutions across the UAE, India, and Iraq.
            </motion.p>
          </div>
        </div>
      </motion.div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CreativeWork",
            "name": "Oil & Gas and Marine Ports Portfolio",
            "creator": {
              "@type": "Organization",
              "name": "Capital Engineering Consultancy",
            },
            "description":
              "A showcase of Capital Engineering Consultancy’s Oil & Gas and Marine Ports engineering projects, including Dulsco, Emirates, Hidd, and MBK, delivering sustainable and innovative infrastructure solutions in the UAE, India, and Iraq.",
