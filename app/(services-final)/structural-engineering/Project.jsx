...
const cards = [
  {
    id: 1,
    src: "/assets/images/servicenew/structural/cricket.jpg",
    alt: "Cricket Stadium Structural Engineering by Capital Engineering Consultancy",
    title: "Cricket Stadium",
  },
  {
    id: 2,
    src: "/assets/images/servicenew/structural/dubaipoliceclub.jpg",
    alt: "Dubai Police Club Structural Engineering by Capital Engineering Consultancy",
    title: "Dubai Police Club",
  },
  {
    id: 3,
    src: "/assets/images/servicenew/structural/Hamriya.jpg",
    alt: "Hamriya Structural Engineering Project by Capital Engineering Consultancy",
    title: "Hamriya Project",
  },
  {
    id: 4,
    src: "/assets/images/servicenew/structural/Wockhardt.jpeg",
    alt: "Wockhardt Manufacturing Facility Structural Engineering by Capital Engineering Consultancy",
    title: "Wockhardt Facility",
  },
];
...
export default function CardSlider() {
  ...
  return (
    <section
      ...
      ref={containerRef}
      aria-labelledby="structural-engineering-portfolio-heading"
    >
      <h2 id="structural-engineering-portfolio-heading" className="sr-only">
        Structural Engineering Portfolio by Capital Engineering Consultancy
      </h2>
      ...
      >
        {!isMobile && (
          <>
            {/* <motion.button
              ...
              aria-label="Previous Structural Engineering portfolio image"
            >
            ...
            <motion.button
              ...
              aria-label="Next Structural Engineering portfolio image"
            >
        ...
        <div
          ...
          {...bind()}
          role="region"
          aria-label="Structural Engineering portfolio carousel"
        >
          <AnimatePresence>
            {cards.map((card, i) => {
              if (!isMobile) {
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 z-50">
          {cards.map((_, i) => (
            <motion.button
              ...
              aria-label={`View Structural Engineering portfolio image ${i + 1}`}
            />
          ))}
        </div>
      </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            >
              At Capital Engineering Consultancy, our structural engineering
              expertise transforms architectural visions into reality through
              innovative, safe, and efficient designs. From stadiums like the
              Cricket project to manufacturing facilities like Wockhardt, we
              deliver structural solutions that combine aesthetic excellence with
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CreativeWork",
            "name": "Structural Engineering Portfolio",
            "creator": {
              "@type": "Organization",
              "name": "Capital Engineering Consultancy",
            },
            "description":
              "A showcase of Capital Engineering Consultancy's structural engineering projects, featuring stadiums, clubs, and manufacturing facilities with innovative and precise structural solutions.",
            "image": cards.map((card) => card.src),
            "keywords":
              "structural engineering, construction design, engineering consultancy, structural solutions, Capital Engineering Consultancy",
          }),
        }}
      />
    </section>
