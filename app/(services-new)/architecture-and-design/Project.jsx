...
const cards = [
  { id: 1, src: "/assets/images/service/archi/s1.jpg", alt: "City View" },
  { id: 2, src: "/assets/images/service/archi/s2.jpeg", alt: "Building View" },
  { id: 3, src: "/assets/images/service/archi/s3.png", alt: "Lake View" },
  { id: 4, src: "/assets/images/service/archi/s4.jpg", alt: "Modern Architecture" },
];
...
export default function CardSlider() {
  ...
  let position =
    "scale-110 translate-x-[20%] opacity-100 z-20 w-[700px] h-[390px]";
  if (!isMobile) {
    if (i === (index + 1) % cards.length) {
      position =
        "translate-x-[150%] translate-y-[10%] scale-70 opacity-70 w-[600px] h-[335px]";
  ...
  return (
    ...
    >
      ...
      <div className="card-title">
        <p className="text-lg font-semibold">{card.alt}</p>
      </div>
...
Your space is more than design—it’s your vision. We craft innovative, functional, and sustainable interiors that suit your needs and aesthetics.</p>
