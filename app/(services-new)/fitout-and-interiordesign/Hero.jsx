  ...
  return (
    <>
      <div className="container-sn ">
        ...
        <div className="card">
          <h1 className="heading wow img-custom-anim-top animated">Fit Out & Interior Design </h1>
      ...
      <div className="description wow img-custom-anim-left animated">
        ...
        We design commercial, residential, and hospitality spaces that reflect innovation and style.
        </p>
      </div>
