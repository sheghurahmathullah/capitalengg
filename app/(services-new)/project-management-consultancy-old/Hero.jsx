  ...
  return (
    <>
      <div className="container-sn ">
        ...
        <div className="card">
          <h1 className="heading wow img-custom-anim-top animated">Project Management Consultancy
          </h1>
          <p className="subtext wow img-custom-anim-top animated">
          Engineering solutions that are precise, efficient, and built for lasting impact.
          </p>
        </div>
      </div>
      ...
      <div className="description wow img-custom-anim-left animated">
        ...
        We design seamless, reliable, and innovative infrastructure that enhances operational efficiency.
        </p>
      </div>
