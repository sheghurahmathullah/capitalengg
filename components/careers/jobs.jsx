...
export default function Features2() {
  ...
  const experiences = [...new Set(featureData4.map(item => item.experience))];
  ...
  const filteredJobs = featureData4.filter(job => {
    return (
      (filters.role === '' || job.title === filters.role) &&
      ...
      <div className="container">
        ...
        {(filters.role || filters.experience || filters.location) && (
          <div style={{ textAlign: 'right', marginBottom: '20px' }}>
            <button 
              onClick={() => setFilters({ role: '', experience: '', location: '' })}
              style={{
                padding: '8px 16px',
        ...
        <div className="row gy-4 align-items-center justify-content-center fs-3">
          {filteredJobs.length > 0 ? (
            ...
            <div className="col-12" style={{ textAlign: 'center', padding: '40px' }}>
              <h3 style={{ color: '#666' }}>No jobs found matching your filters</h3>
              <button
                onClick={() => setFilters({ role: '', experience: '', location: '' })}
                style={{
                  padding: '10px 20px',
